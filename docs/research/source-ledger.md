...
| SongEval | [paper](https://arxiv.org/abs/2505.10793) | 2,399 full songs, over 140 hours, 16 professional annotators, five aesthetic dimensions | motivates full-song multidimensional human calibration | benchmark publication does not make its axes universal |
